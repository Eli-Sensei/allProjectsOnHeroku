...
if (is_array($trimedData) && count($trimedData) > 0) {
    ...
    foreach ($trimedData as $key => $value) {
        # code...
        $cook = setcookie($key, $value, time()+10);
        var_dump($cook);
        echo '<br> $cook';
    }
        ...
        <div class="container">
               ...
               <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                         ...
                         <li class="nav-item active">
                              <a class="nav-link" href="" id="bidule"> <?php echo $_SESSION['username'] ?> </a>
                         </li>
                         <!-- <li class="nav-item">
     ...
     <section>
                        <div class="row">
                             <div class="container col-9">
                              <h2 id="write">&EmptyVerySmallSquare;</h2>
...
<script>
     let wordContainer = document.querySelector('#write');
     let username = document.querySelector('#bidule').innerHTML;
     function writeWord(word, container, timeToPop, timeToDisplay) {
     setTimeout(()=>{
          let i = 0;
     ...
     writeWord("Bienvenue ", wordContainer, 1000, 80);
     writeWord(username, wordContainer, 3080, 100);
